use crate::repositories::pokemon::{InMemoryRepository, Repository, FetchAllError};
use std::sync::Arc;
...
mod tests {
    ...
    fn it_should_return_all_pokemons_ordered_by_increasing_number_otherwise() {
        ...
        repo.insert(PokemonNumber::charmander(), PokemonName::charmander(), PokemonTypes::charmander()).ok();
